...
Default$income standard error:  4.985e-06
Default$balance standard error: 2.274e-07
...
```{r}
boot::boot(Default$income, statistic=boot.fn, R=15)
boot::boot(Default$balance, statistic=boot.fn, R=15)
...
for (i in n) {
  glm.fitWithoutI = glm(Weekly$Direction[1:i-1])
}
```
