...
plot(latitude.fungi, col=(kmeans.out$cluster + 1), main = "Latitude and Fungi", xlab = "Latitude", ylab = "Fungi")
```
...
plot(vasc.plants.latitude, col=(kmeans.out$cluster + 1), main = "Latitude and Vascular Plants", xlab = "Latitude", ylab = "Vascular Plants")
```
