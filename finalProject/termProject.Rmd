...
categoryFreq = function(old.frequencies.df, category) {
  parkIndex = 1
  ...
  for(parkIndex in numParks) {
    ...
    old.frequencies.df[parkIndex, 18] = sum(temp.data$Category == category)
    # the second value in the brackets corresponds to the frequency column in
    # frequencies.df. Change this accordingly when using (bad hack)
  }
