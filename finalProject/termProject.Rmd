...
A subset data frame for clustering with only quantitative vectors
...
plot(latitude.fungi, col=(kmeans.out$cluster + 1), main = "Category Observation Frequency", xlab = "Latitude", ylab = "Fungi")
```
